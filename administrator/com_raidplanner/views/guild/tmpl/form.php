...
<form action="index.php" method="post" name="adminForm" id="adminForm" class="form-horizontal">
	<fieldset class="adminform">
		...
		<div class="control-group">
			...
			<div class="controls">
				<select name="sync_plugin" id="sync_plugin" onchange="document.id('plugin_settings').setStyle('display','none');document.id('plugin_settings_warning').setStyle('display','');">
					<option value=""></option>
